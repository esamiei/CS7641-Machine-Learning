...
def continuous_peaks_fitness_curve_hyperparameter_sa(t_pct_threshold=0.15, state_length=80):

    fitness = mlrose_hiive.ContinuousPeaks(t_pct=t_pct_threshold)
    ...
    if gen_plot:
        ...
        plt.grid()
        plt.legend(loc='best')
        fig.savefig("Images/continuous_peaks_sa_hyperparameter.png")
        #plt.show()
...
def continuous_peaks_fitness_curve_hyperparameter_rhc(t_pct_threshold=0.15, state_length=80):
    ...
    if gen_plot:
        ...
        plt.grid()
        plt.legend(loc='best')
        fig.savefig("Images/Continuous_peaks_rhc_hyperparameter.png")
        #plt.show()
...
def continuous_peaks_fitness_curve_hyperparameter_ga(t_pct_threshold=0.15, state_length=80):
    ...
    if gen_plot:
        ...
        plt.grid()
        plt.legend(loc='best')
        fig.savefig("Images/continuous_peaks_ga_hyperparameter.png")
        #plt.show()
...
def continuous_peaks_fitness_curve_hyperparameter_mimic(t_pct_threshold=0.15, state_length=80):
    ...
    if gen_plot:
        ...
        plt.grid()
        plt.legend(loc='best')
        fig.savefig("Images/continuous_peaks_mimic_hyperparameter.png")
...
def continuous_peaks_fitness_curve_iterations(best_schedule,best_restarts,best_mutation_prob,best_pop_size,t_pct_threshold=0.15, state_length=80):
    ...
    fig, ax = plt.subplots(figsize=(6, 4))
    ax.set_title("Fitness Curve vs number of Iterations | ContinuousPeaks Problem")
    ax.set_xlabel('Iterations')
    ax.set_ylabel('fitness')
    ...
    ax.grid()
    ax.legend(loc='best')
    fig.savefig("Images/continuous_peaks_iterations.png")
    
    fig, ax = plt.subplots(figsize=(6, 4))
    ax.set_title("Best fitness score | ContinuousPeaks")
    ...
    fig.savefig("Images/continuous_peaks_iteration_best_score.png")
    
    fig, ax = plt.subplots(figsize=(6, 4))
    ax.set_title("Run tim| ContinuousPeaks")
    ax.set_xlabel('Optimization Algorithm')
    ...
    fig.savefig("Images/continuous_peaks_iteration_run_time.png")
...
def continuous_peaks_state_size(best_schedule,best_restarts,best_mutation_prob,best_pop_size,t_pct_threshold=0.15, state_size_tunned_for=200, length=range(5, 206, 20)):
    ...
    if gen_plot:
        ...
        plt.grid()
        plt.legend(loc='best')
        fig.savefig("Images/continuous_peaks_fitness_varying_state.png")
    ...
    if gen_plot:
        ...
        plt.grid()
        plt.legend(loc='best')
        fig.savefig("Images/continuous_peaks_varying_state_time.png")
...
def continuous_peaks_T_threshold_tuning(best_schedule,best_restarts,best_mutation_prob,best_pop_size,t_pct_threshold=0.15, state_length=80):
    ...
    for i, t_pct_threshold in enumerate(t_pct_thresholds):
        ...
        fig, ax = plt.subplots(figsize=(6, 4))
        ax.set_title("Fitness Curve with varying T threshold | ContinuousPeaks Problem")
        ax.set_xlabel('Iterations')
        ...
        ax.grid()
        ax.legend(loc='best')
        fig.savefig("Images/continuous_peaks_iterations_T_{}.png".format(t_pct_threshold))
...
if __name__ == "__main__":
    ...
    best_schedule=continuous_peaks_fitness_curve_hyperparameter_sa(t_pct_threshold=0.15, state_length=80)

    # Run hyperparameter restarts for RHC
    best_restarts=continuous_peaks_fitness_curve_hyperparameter_rhc(t_pct_threshold=0.15, state_length=80)

    # Run hyperparameter mutation_prob for GA
    best_mutation_prob=continuous_peaks_fitness_curve_hyperparameter_ga(t_pct_threshold=0.15, state_length=80)
    
    # Run hyperparameter pop_size for MIMIC
    best_pop_size=continuous_peaks_fitness_curve_hyperparameter_mimic(t_pct_threshold=0.15, state_length=80)
    
    # Run the fitness curve at evey iteration
    continuous_peaks_fitness_curve_iterations(best_schedule,best_restarts,best_mutation_prob,best_pop_size,t_pct_threshold=0.15, state_length=80)
    
    # Run state space size
    continuous_peaks_state_size(best_schedule,best_restarts,best_mutation_prob,best_pop_size,t_pct_threshold=0.15,state_size_tunned_for=80)

    # Run different t_pct threshold values
    continuous_peaks_T_threshold_tuning(best_schedule,best_restarts,best_mutation_prob,best_pop_size,t_pct_threshold=0.15, state_length=80)
